      ...
      <div className="order-1 flex flex-col space-y-1 px-4 md:px-8 lg:order-2 lg:px-0">
        <div className="flex flex-row lg:flex-col">
          ...
          <CompanyButton
            ...
            CompanyName="SlashMark"
            BarPosition={90}
            DescriptionJob="SlashMark"
            CompanyNameBackgroundColorGreen={[
              false,
              false,
              true,
          ...
          <CompanyButton
            ...
            CompanyName="Treasurer"
            BarPosition={195}
            BarAbovePosition={257}
            DescriptionJob="Treasurer"
            CompanyNameBackgroundColorGreen={[
              false,
              false,
              false,
