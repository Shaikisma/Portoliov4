  ...
  return (
    <nav className="sticky left-0 top-0 z-[100] w-full bg-bgDark shadow-lg">
      ...
      >
        ...
        >
          {/* for mobile view */}
          <span className="sm:hidden">@Ismail</span>
          {/* for web view */}
          <span className="hidden sm:block">@Ismail Shaik</span>
        </ScrollLink>
            ...
            >
              <div className="relative flex flex-col p-5 sm:p-10 lg:hidden">
                ...
                <div className="flex gap-4 border-b-2 border-b-white p-6 text-[22px]">
                  ...
                  <a href="https://github.com/Shaikisma" target="_blank">
                    <BsGithub />
                  </a>
                  <a href="https://x.com/zenismail09" target="_blank">
                    <FaXTwitter />
                  </a>
                  <a href="mailto:shaik.ismail5799@gmail.com" target="_blank">
                    <HiMailOpen />
                  </a>
                </div>
        ...
        <div className="hidden items-center justify-between gap-2 text-[24px] lg:flex">
          ...
          <span className="cursor-pointer px-1 py-2 transition-all duration-500 ease-in-out hover:-translate-y-[2px]">
            <a
              href="https://github.com/Shaikisma"
              target="_blank"
              title="Github"
            >
              <BsGithub />
          ...
          <span className="cursor-pointer px-1 py-2 transition-all duration-500 ease-in-out hover:-translate-y-[2px]">
            <a
              href="mailto:shaik.ismail5799@gmail.com"
              target="_blank"
              title="Email"
            >
              <HiMailOpen />
